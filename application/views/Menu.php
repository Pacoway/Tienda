	...
	<ul class="navbar-nav float-right">
		...
		<li class="nav-item">
			<a class="nav-link dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
			 aria-haspopup="true" aria-expanded="false" ref=''>Administrar</a>
			<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">

				<a class="dropdown-item" href="<?= site_url().'/AdministrarCategoria/'?>"> Categorias </a>
				<a class="dropdown-item" href="<?= site_url().'/AdministrarProducto/'?>"> Productos </a>
				<a class="dropdown-item" href="<?= site_url().'/AdministrarEstado/'?>"> Pedidos </a>

			</div>
		</li>
		<?php endif; ?>
		<?php if ($this->session->userdata('usuario_id')) :?>
		<li class="nav-item"> <a class="nav-link" href="<?= site_url().'/PerfilUsuario' ?>"> Bienvenido
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	<ul class="navbar-nav">
		...
		<li class="nav-item">
			<a class="nav-link dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown"
			 aria-haspopup="true" aria-expanded="false" ref='<?= base_url(); ?>categorias'>Categorias</a>
			<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
				<?php foreach ($categorias as $row) : ?>
				<a class="dropdown-item" href="<?= site_url().'/Productos/mostrarCategorias/'.$row->categoria_id?>">
					<?= $row->nombre ?></a>
				<?php endforeach; ?>
			</div>
		</li>
