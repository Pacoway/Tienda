...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-03-2019 a las 05:43:30
...
CREATE TABLE `linea_pedido` (
  ...
  `imagen_producto` varchar(50) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `linea_pedido` (`linea_pedido_id`, `cantidad`, `importe`, `producto_id`, `pedido_id`, `nombre_producto`, `imagen_producto`) VALUES
(1, 3, '99', 1, 50, 'HP Envy 5030', 'HPEnvy5030.jpg'),
(2, 2, '10', 12, 50, 'Fibra de coco', 'Fibradecoco.jpg'),
(3, 3, '99', 1, 51, 'HP Envy 5030', 'HPEnvy5030.jpg'),
(4, 2, '10', 12, 51, 'Fibra de coco', 'Fibradecoco.jpg'),
(5, 3, '99', 1, 52, 'HP Envy 5030', 'HPEnvy5030.jpg'),
(6, 2, '10', 12, 52, 'Fibra de coco', 'Fibradecoco.jpg'),
(7, 3, '99', 1, 53, 'HP Envy 5030', 'HPEnvy5030.jpg'),
(8, 2, '10', 12, 53, 'Fibra de coco', 'Fibradecoco.jpg'),
(9, 3, '99', 1, 54, 'HP Envy 5030', 'HPEnvy5030.jpg'),
(10, 2, '10', 12, 54, 'Fibra de coco', 'Fibradecoco.jpg'),
(11, 1, '12', 8, 57, 'SanDisk Ultra Flair 64GB', 'SanDiskUltraFlair64GB.jpg'),
(12, 1, '10', 15, 57, 'Maceta Vivero', 'MacetaVivero.jpg'),
(13, 1, '99', 13, 60, 'HOMCOM Invernadero', 'HOMCOMInvernadero.jpg'),
(14, 1, '10', 15, 79, 'Maceta Vivero', 'MacetaVivero.jpg'),
(15, 2, '3', 18, 79, 'Semillas Ecologicas', 'SemillasEcologicas.jpg'),
(16, 1, '33', 2, 85, 'Kingston SSD A400', 'KingstonSSDA400.jpg'),
(17, 2, '66', 2, 86, 'Kingston SSD A400', 'KingstonSSDA400.jpg'),
(18, 1, '13', 5, 87, 'Mini Teclado Inalámbrico MECO Mini', 'MiniTecladoInalámbricoMECOMini.jpg'),
(19, 1, '13', 5, 88, 'Mini Teclado Inalámbrico MECO Mini', 'MiniTecladoInalámbricoMECOMini.jpg'),
(20, 1, '13', 5, 89, 'Mini Teclado Inalámbrico MECO Mini', 'MiniTecladoInalámbricoMECOMini.jpg'),
(21, 1, '2', 18, 91, 'Semillas Ecologicas', 'SemillasEcologicas.jpg'),
(22, 1, '10', 15, 93, 'Maceta Vivero', 'MacetaVivero.jpg'),
(23, 2, '20', 16, 95, 'Semillas de Cesped', 'SemillasdeCesped.jpg'),
(24, 1, '10', 15, 96, 'Maceta Vivero', 'MacetaVivero.jpg');
...
CREATE TABLE `pedido` (
  ...
  `estado` char(2) COLLATE utf8_spanish_ci DEFAULT 'P',
  `usuario_id` int(11) NOT NULL,
  `nombre_usuario_pedido` varchar(30) COLLATE utf8_spanish_ci NOT NULL,
  `apellidos_pedido` varchar(30) COLLATE utf8_spanish_ci NOT NULL,
  `dni_pedido` varchar(10) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `pedido` (`pedido_id`, `fecha`, `estado`, `usuario_id`, `nombre_usuario_pedido`, `apellidos_pedido`, `dni_pedido`) VALUES
(1, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(2, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(3, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(4, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(5, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(6, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(7, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(8, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(9, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(10, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(11, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(12, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(13, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(14, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(15, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(16, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(17, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(18, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(19, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(20, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(21, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(22, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(23, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(24, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(25, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(26, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(27, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(28, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(29, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(30, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(31, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(32, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(33, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(34, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(35, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(36, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(37, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(38, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(39, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(40, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(41, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(42, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(43, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(44, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(45, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(46, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(47, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(48, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(49, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(50, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(51, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(52, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(53, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(54, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(55, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(56, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(57, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(58, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(59, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(60, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(61, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(62, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(63, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(64, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(65, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(66, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(67, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(68, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(69, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(70, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(71, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(72, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(73, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(74, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(75, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(76, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(77, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(78, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(79, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(80, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(81, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(82, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(83, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(84, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(85, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(86, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(87, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(88, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(89, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(90, NULL, 'P', 3, 'Paco', 'way', '12345678T'),
(91, NULL, 'P', 5, 'Francisco', 'Moriña Rengel', '12345678T'),
(92, NULL, 'P', 5, 'Francisco', 'Moriña Rengel', '12345678T'),
(93, NULL, 'P', 2, 'Administrador', 'Admin', '12345678T'),
(94, NULL, 'P', 2, 'Administrador', 'Admin', '12345678T'),
(95, NULL, 'P', 2, 'Administrador', 'Admin', '12345678T'),
(96, NULL, 'P', 3, 'Usuario', 'Usuario', '12345678T');
...
(26, 'Gibson les Paul Z.Wyl', '28.09', 29, 'GibsonlesPaulZ.Wyl.jpg', 21, 'Miniatura de la legendaria guitarra de paul Z.Wyl', NULL, 20, 3, 1, 0, NULL, NULL),
...
(2, 'Admin', 'Admin', 'Prueba@hotmail.com', 'Administrador', 'Admin', '12345678T', 'Huelva', 21, 1),
(3, 'Usuario', 'Usuario', 'pakoway_@hotmail.com', 'Usuario', 'Usuario', '12345678T', 'casa', 13, 0),
(5, 'Prueba', 'Prueba', 'pakoway_@hotmail.com', 'Prueba', 'Prueba', '12345678T', 'Huelva', 21, 0);
...
--
ALTER TABLE `linea_pedido`
  MODIFY `linea_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT de la tabla `pedido`
--
ALTER TABLE `pedido`
  MODIFY `pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
